...
namespace SFA.DAS.Tasks.Worker.MessageProcessors
{
    ...
    [TopicSubscription("Task_CohortApproved")]
    public class CohortApprovedMessageProcessor : MessageProcessor2<CohortApprovedByEmployer>
    {
        private readonly ILog _logger;
        private readonly IMediator _mediator;

        public CohortApprovedMessageProcessor(IMessageSubscriberFactory subscriberFactory, ILog logger, IMessageContextProvider messageContextProvider, IMediator mediator) 
