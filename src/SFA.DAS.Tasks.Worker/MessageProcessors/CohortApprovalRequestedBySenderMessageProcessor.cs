...
namespace SFA.DAS.Tasks.Worker.MessageProcessors
{
    ...
    public class CohortApprovalRequestedBySenderMessageProcessor : MessageProcessor2<CohortApprovalByTransferSenderRequested>
    {
        ...
        public CohortApprovalRequestedBySenderMessageProcessor(IMessageSubscriberFactory subscriberFactory, ILog log, IMessageContextProvider messageContextProvider, IMediator mediator) 
