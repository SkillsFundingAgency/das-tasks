...
namespace SFA.DAS.Tasks.Worker.MessageProcessors
{
    ...
    public class CohortRejectedBySenderMessageProcessor : MessageProcessor2<CohortRejectedByTransferSender>
    {
        ...
        public CohortRejectedBySenderMessageProcessor(IMessageSubscriberFactory subscriberFactory, ILog log, IMessageContextProvider messageContextProvider, IMediator mediator) 
