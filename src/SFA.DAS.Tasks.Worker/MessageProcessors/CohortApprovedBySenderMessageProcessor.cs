...
namespace SFA.DAS.Tasks.Worker.MessageProcessors
{
    ...
    public class CohortApprovedBySenderMessageProcessor : MessageProcessor2<CohortApprovedByTransferSender>
    {
        ...
        public CohortApprovedBySenderMessageProcessor(IMessageSubscriberFactory subscriberFactory, ILog log, IMessageContextProvider messageContextProvider, IMediator mediator) 
