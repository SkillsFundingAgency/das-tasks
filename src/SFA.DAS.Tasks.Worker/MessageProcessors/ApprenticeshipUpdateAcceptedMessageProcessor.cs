...
namespace SFA.DAS.Tasks.Worker.MessageProcessors
{
    ...
    public class ApprenticeshipUpdateAcceptedMessageProcessor : MessageProcessor2<ApprenticeshipUpdateAccepted>
    {
        ...
        public ApprenticeshipUpdateAcceptedMessageProcessor(IMessageSubscriberFactory subscriberFactory, ILog logger, IMessageContextProvider messageContextProvider, IMediator mediator) 
