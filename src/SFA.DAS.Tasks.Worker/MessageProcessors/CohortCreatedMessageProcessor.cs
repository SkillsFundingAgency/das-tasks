...
namespace SFA.DAS.Tasks.Worker.MessageProcessors
{
    ...
    public class CohortCreatedMessageProcessor : MessageProcessor2<CohortCreated>
    {
        private readonly ILog _logger;
        private readonly IMediator _mediator;

        public CohortCreatedMessageProcessor(IMessageSubscriberFactory subscriberFactory, ILog log, IMessageContextProvider messageContextProvider, IMediator mediator) 
