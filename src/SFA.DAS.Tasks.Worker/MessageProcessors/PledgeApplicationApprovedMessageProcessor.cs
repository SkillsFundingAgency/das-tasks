...
namespace SFA.DAS.Tasks.Worker.MessageProcessors
{
    ...
    public class PledgeApplicationApprovedMessageProcessor : MessageProcessor2<PledgeApplicationApproved>
    {
        private readonly ILog _logger;
        private readonly IMediator _mediator;

        public PledgeApplicationApprovedMessageProcessor(IMessageSubscriberFactory subscriberFactory, ILog logger, IMessageContextProvider messageContextProvider, IMediator mediator)
