...
namespace SFA.DAS.Tasks.Worker.MessageProcessors
{
    ...
    public class CohortApprovalRequestedMessageProcessor: MessageProcessor2<CohortApprovalRequestedByProvider>
    {
        ...
        public CohortApprovalRequestedMessageProcessor(IMessageSubscriberFactory subscriberFactory, ILog log, IMessageContextProvider messageContextProvider, IMediator mediator) 
