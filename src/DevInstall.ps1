...
#Import-PfxCertificate -FilePath DasTaskCert.pfx -CertStoreLocation cert://LocalMachine/My -Password $certpwd -Exportable
#Import-PfxCertificate -FilePath DasTaskCert.pfx -CertStoreLocation cert://LocalMachine/Root -Password $certpwd -Exportable
